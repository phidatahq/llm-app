...
######################################################
## Router for ArXiv Conversations
######################################################
...
@arxiv_router.post("/conversation/create", response_model=CreateConversationResponse)
...
@arxiv_router.post("/chat")
def chat(body: ChatRequest):
    """Send a message to the ARXIV Conversation and return the response"""
...
@arxiv_router.post("/chat/history", response_model=List[Dict[str, Any]])
...
@arxiv_router.post("/conversation/get", response_model=Optional[ConversationRow])
...
@arxiv_router.post("/conversation/get-all", response_model=List[ConversationRow])
...
@arxiv_router.post("/conversation/get-all-ids", response_model=List[int])
...
@arxiv_router.post("/conversation/rename", response_model=RenameConversationResponse)
...
@arxiv_router.post("/conversation/end", response_model=Optional[ConversationRow])
